<template>
  <section role="contentinfo" class="uksection" aria-label="Table">
...
1. 기본: 가운데 정렬 (글자가 유동적이고, 긴 글은 왼쪽 정렬)
2. 제목 및 열에 해당 class 추가 (없을 시 새로 작성)
3. 왼쪽 정렬 시: 클래스 추가 한 후, 스타일에 선택자 추가!

번호(가운데):    th.c-hcell-digit,    td.c-cell-digit
구분(왼쪽):    th.c-hcell-part,    td.c-cell-part
유형(왼쪽):    th.c-hcell-type,    td.c-cell-type
내용, 제목(왼쪽):    th.c-hcell-subject,    td.c-cell-subject
조회(가운데):    th.c-hcell-view,    td.c-cell-view
추천(가운데):    th.c-hcell-like,    td.c-cell-like
대상(왼쪽):    th.c-hcell-target,    td.c-cell-target
진행사항(가운데):    th.c-hcell-progress,    td.c-cell-progress
작성자(가운데):    th.c-hcell-writer,    td.c-cell-writer
작성일(가운데):    th.c-hcell-date,    td.c-cell-date
파일명(왼쪽):    th.c-hcell-filename,    td.c-cell-filename
사이즈(가운데):    th.c-hcell-size,    td.c-cell-size
      </textarea>
    </div>
    <div class="code-editor">
      <textarea style="height: 200px">
...
<div class="row c-table">
  <b-table class="m-bv-table" style="width: 100%" sticky-header :items="stickyHeaderTableInfo.items" :fields="stickyHeaderTableInfo.fields"></b-table>
    ...
    <br />
    <br />
    <p class="h4">헤더고정 테이블 + filter + 페이징</p>
    <br />
    <div class="row c-table -mt-20">
